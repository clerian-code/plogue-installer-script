...
From the directory containing plogue-installer.sh, run `./plogue-installer.sh -i local -f path_to_zip_file_here`
If you were to use this on the current version of OPS7 (at the time of writing this, 1.124), a fully qualified example would be `./plogue-installer.sh -i local -f LINUX_plogue-chipsynth-ops7_1.124~beta1_x86_64.zip`
